...
public class ObstaclesHandler {
    ...
    public ArrayList<Rectangle> createObstacles() {
        int width = 25;
        double xPos = planeHeight;
        double space = 200;
        double rectTopHeight = random.nextInt((int) (planeHeight - space - 100)) + 50;
        double rectBottomHeight = planeHeight - space - rectTopHeight;
        Rectangle rectangleTop = new Rectangle(xPos, 0, width, rectBottomHeight);
        Rectangle rectangleBottom = new Rectangle(xPos, rectBottomHeight + space, width, rectBottomHeight);
